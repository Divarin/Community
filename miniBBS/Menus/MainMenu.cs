...
namespace miniBBS.Menus
{
    public static class MainMenu
    {
        private static readonly string[] _lines = new[]
        {
            ...
            //"/pp (minutes) : Starts or stops 'Ping? Pong!' anti-timeout function needed for some telnet clients.",
            $"{Constants.Spaceholder}{Constants.Spaceholder}/pp 0 : Stops 'Ping? Pong!'",
            $"{Constants.Spaceholder}{Constants.Spaceholder}/pp 1 : Starts 'Ping? Pong!' every 1 minute",
            $"{Constants.Spaceholder}{Constants.Spaceholder}/pp 5 : Starts 'Ping? Pong!' every 5 minutes",
            $"{Constants.Spaceholder}",
            "About the prompt:",            
