...
namespace miniBBS.Menus
{
    public static class About
    {
        ...
        {
            $"{Constants.Inverser}*** About {Constants.BbsName} ***{Constants.Inverser}",
            $"Version: {Constants.Version}",
            $"{Constants.Spaceholder}",
            $"{Constants.BbsName} is a new kind of Bulletin Board System (BBS).  " +
            ...
            $"{Constants.Spaceholder}",
            $"Here at {Constants.BbsName} the format is differnet.  It's more like a chat session " +
            ...
            $"{Constants.Spaceholder}",
            $"So {Constants.BbsName} combines these two formats (Forums and Chat) and turns it into a " +
            ...
            $"file transfers, and the other usual BBSy things.  But here at {Constants.BbsName} it's purely chat."
        };
