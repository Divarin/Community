...
namespace miniBBS.Menus
{
    public static class CommandList
    {
        public static readonly SortedSet<Cmd> _commands = new SortedSet<Cmd>(new CmdComparer())
        {
            ...
            new Cmd("/pwd",3), new Cmd("/fauxmain", 4), new Cmd("/main", 4), new Cmd("/menu", 4), new Cmd("fauxmenu", 4),
            new Cmd("/fakemain", 4), new Cmd("/fakemenu", 4), new Cmd("/term",5), new Cmd("/setup",5), new Cmd("/emu",5), new Cmd("/bell",6), 
            ...
            new Cmd("/ctx",23), new Cmd("/cx",23), new Cmd("/re",23), new Cmd("/ref",23), new Cmd("/wat",23), new Cmd("/new",24), 
            ...
            new Cmd("/fairwell",35), new Cmd("/farewell",35), new Cmd("/goodbye",35), new Cmd("/bye",35), new Cmd("/roll",36), 
